define([
    ...
    Preview.prototype.bindEvents = function bindEvents() {
        ...
        events.on("gc-row-special-banner:dropAfter", function (args) {
    ...
    /**
     * Add an Asset component
     */
    Preview.prototype.addHeading = function () {
        const self = this;
        createContentType(
     ...
     * Add an Asset component
     */
    Preview.prototype.addAsset = function () {
        const self = this;
        createContentType(
            pageBuilderConfig.getContentTypeConfig("gc-asset"),
            this.contentType,
            this.contentType.stageId,
            {}
        ).then(function (container) {
