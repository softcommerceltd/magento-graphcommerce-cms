...
namespace SoftCommerce\GraphCommerceCms\Framework\GraphQl\Schema;
...
/**
 * @preference for
 * @see \Magento\Framework\GraphQlSchemaStitching\GraphQlReader
 * Used to add dynamic custom scalar types to graphQL schema reader.
 *
 * @todo Work on the following github issues to resolve custom scalar types:
 * @link https://github.com/magento/magento2/issues/37768
 * @link https://github.com/magento/magento2/issues/36877
 */
class SchemaStitchingGraphQlReader implements ReaderInterface
{
     ...
     */
    private TypeReaderComposite $typeReader;
